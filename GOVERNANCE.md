...
`cloud-itonami-7810` is an OSS open-business blueprint for community employment agency, robotics-premised.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- a robot action the governor refuses is never dispatched to hardware.
- the Employment Agency Governor remains independent of the advisor.
