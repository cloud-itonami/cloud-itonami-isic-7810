...
- human sign-off for :high/:safety-critical robot actions (e.g. handling sensitive candidate data and high-stakes placement decisions)
...
## Operating states
intake : register : match : place : follow-up : audit
